...
// day7 Part 2
func main() {
	input, err := util.GetPart2InputFileLines("./day7")
	//input, err := util.GetExample2InputFileLines("./day7")
	util.Check(err)
...
func determineHandType(cards []Card) HandType {
	...
	if isFiveOfAKind(slice, numOfJokers) {
		return FiveOfAKind
	}
	if isFourOfAKind(slice, numOfJokers) {
		return FourOfAKind
	}
	if isFullHouse(slice, numOfJokers) {
		return FullHouse
	}
	if isThreeOfAKind(slice, numOfJokers) {
		return ThreeOfAKind
	}
	if isTwoPair(slice, numOfJokers) {
		return TwoPair
	}
	if isOnePair(slice, numOfJokers) {
		return OnePair
	}
	return HighCard
}

func isFiveOfAKind(arr []int, numOfJokers int) bool {
	for i := 0; i < len(arr); i++ {
		if arr[i]+numOfJokers == 5 {
			return true
		}
	}
	return false
...
func isFourOfAKind(arr []int, numOfJokers int) bool {
	for i := 0; i < len(arr); i++ {
		if arr[i]+numOfJokers == 4 {
			return true
		}
	}
	return false
...
func isFullHouse(arr []int, numOfJokers int) bool {
	for i := 0; i < len(arr); i++ {
		if arr[i]+numOfJokers == 3 {
			for j := 0; j < len(arr); j++ {
				if i != j && arr[j] == 2 {
					return true
				}
...
func isThreeOfAKind(arr []int, numOfJokers int) bool {
	for i := 0; i < len(arr); i++ {
		if arr[i]+numOfJokers == 3 {
			return true
		}
...
func isTwoPair(arr []int, numOfJokers int) bool {
	count := 0
	for i := 0; i < len(arr); i++ {
		if arr[i]+numOfJokers == 2 {
			count++
		}
	}
	return count == 2
...
func isOnePair(arr []int, numOfJokers int) bool {
	for i := 0; i < len(arr); i++ {
		if arr[i]+numOfJokers == 2 {
			return true
		}
